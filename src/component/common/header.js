        ...
        <>
            ...
            <div className="container">
                ...
                <button className="hamburger" onClick={() => {
                    ...
                    {
                        isNavExpanded? <div style={{color:"#fff"}}>X</div>:<BurgerSvg />
                    }
                </button>
                ...
                <div className={isNavExpanded ? "navigation-menu expanded" : "navigation-menu"}>
                    <div class=" navbar-nav ms-auto py-4 py-lg-0">
                        ...
                        <li><a href="#" class="nav-item nav-link">Community</a></li>
                            ...
                            <li><a href="/Job" class="nav-item nav-link">Jobs</a></li>
                        
                            <li><a href="#" class="nav-item nav-link">Newsroom</a></li>
                            <li><a href="#" class="nav-item nav-link active"><i class="fa fa-search"></i></a></li>
                            {
                                logged_token ? (
                                    ...
                                    <>
                                    <li><a href="/Signup" class="nav-item nav-link">Join us</a></li>
                                    <li className="login_btn"><a class="btn btn-square1 text-white me-2 " href="/Login">Login</a></li>
                                    </>
                                )
                            }
