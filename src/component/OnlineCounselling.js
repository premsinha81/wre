                        ...
                        <div className="border1">
                            ...
                            <div className="onlinecousectinp">
                                ...
                                <div className="programsSection1">
                                    <center> <button type="button" className="btn btn-primary btnSidebar sortBtn btnFuture">SUBMIT</button> </center>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="container">
                                <div className="row  ">
                                    <div className="col-md-12 section-h">
                                        <div className="bannerHeadingcoun">
                                            <center>
                                                <h1>Personalised Expert Guidance</h1>
                                            </center>
                                        </div>
                                    </div>
                ...
                <div className="programsSection">
                    <div className="row ">
                        <div className="col-lg-12 col-xl-12 ">
                            ...
                            <div className=" counpro1">
                                <p>Plan your career, stream/ subject combinations, course, college and more through expert guidance. All our career coaches are International Certified who have mentored over 2.5 million students. Make the right choice with personalised career counselling and all-round support for all your queries
                                </p>
