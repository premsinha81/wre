...
function CollgeDetails() {
     ...
     useEffect(() => {
         axios.get(`http://162.144.98.113/~work/wre/api/college_detail?college_id`+college_id)
             .then(function (result) {
                 // console.log(result)
                 if (result.data.status.status_code == 200) {
                     setcourse_details(result.data.results)
     ...
     // console.log(course_details.results.title)
     return (
         <>
                         ...
                         <div className="row  ">
                             <div className="col-md-8 section-h">
                                 <div className="bannerHeading">
                                     <h1>{course_details.college_name}</h1>
                                 </div>
                             </div>
