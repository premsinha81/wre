...
function Signup() {
  ...
  <div className="row justify-content-md-center">
    ...
    <div className="col-md-12 text-right">
          <button onClick={() => setPopupVisible(false)}><i className='fa fa-window-close '></i></button>
          </div>
          ...
          <div className="col-md-12 section-h py-4">
                                                <div className="input-box">
                                                    <button type="submit" onClick={() => handleSubmit()} className="submitButton" >   Verify</button>
                                                </div>
                                            </div>
